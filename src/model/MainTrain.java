...
import inputOutput.AnomalyDetectionHandler;
import inputOutput.Server;
...
/*
	@SuppressWarnings("decleration")
	public static void main(String[] args) throws Exception {
		String path="";
		String className="";
		URLClassLoader classLoader=new URLClassLoader.newInstance(new URL[]{new URL("file://"+path)});
